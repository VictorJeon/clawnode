          ...
          <FadeIn delay={0.15}>
            <div className="bg-[#0A0A0A] border border-[#FF6B00]/30 rounded-3xl p-8 md:p-10 relative flex flex-col h-full shadow-[0_0_40px_rgba(255,107,0,0.08)]">
              ...
              <div className="mb-8">
                ...
                <p className="text-sm text-gray-400">현장 방문 설치 + 2시간 1:1 교육 + 맞춤 봇</p>
              </div>
              <div className="mb-8">
              ...
              <div className="bg-[#FF6B00]/10 border border-[#FF6B00]/20 rounded-xl p-4 mb-8">
                <div className="grid grid-cols-3 gap-4 text-center divide-x divide-[#FF6B00]/20">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">현장 설치 강의</div>
                  </div>
                  <div>
                    <div className="text-xl font-bold text-white">1 Bot</div>
                    <div className="text-xs text-gray-400">맞춤 자동화 제작</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 flex-1">
                ...
                <div>
                  <h4 className="font-bold border-b border-white/10 pb-2 mb-4 text-sm">교육 & 지원</h4>
                  <ul className="space-y-3">
                    {[
                      '서울/경기 현장 방문 설치',
                      '2시간 1:1 활용 강의',
          ...
          <div className="md:hidden space-y-4">
            {[
              ...
              <div key={item.feature} className="bg-[#0A0A0A] border border-white/10 rounded-xl p-4">
                ...
                <div className="text-sm text-[#FF6B00] font-medium">올인원: {item.premium}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 md:px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            당신의 AI 운영팀,
            <br />
            <span className="text-[#FF6B00]">지금 세팅하세요.</span>
          </h2>
