      ...
      <section className="py-24 px-4 md:px-6 bg-white/[0.02] overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="flex gap-6 mb-6 animate-marquee-left">
            {[
              { name: '김R***', role: '스타트업 대표', pkg: '올인원', text: '여태껏 써본 AI 프로그램 중에 제일 똑똑합니다. 경쟁사 분석부터 투자 IR 자료까지 알아서 만들어요. 신세계를 경험했어요.' },
              { name: '이O호', role: '병원장', pkg: '올인원', text: '진료 끝나고 텔레그램에 "오늘 환자 통계 정리해줘" 하면 다음 날 아침에 리포트가 와 있어요. 직원 한 명 더 고용한 셈입니다.' },
              { name: '이O욱', role: '교직원', pkg: '올인원', text: '77일치 커리큘럼을 짜고 학습지를 만들어서 구글드라이브에 자동으로 올려줘요. 직접 설치해서 쓰는 친구 것보다 지능이 압도적이에요.' },
              { name: '윤O영', role: '스타트업 COO', pkg: '올인원', text: '상담부터 설치까지 기대 이상이었어요. 지금은 매일 아침 경영 브리핑을 받고 있는데, 이게 월 구독료 없이 돌아간다는 게 믿기지 않아요.' },
              { name: '박O준', role: '1인 쇼핑몰 운영', pkg: '베이직', text: '재고 관리, CS 응대 초안, 상품 소싱 리서치까지 혼자 다 해줘요. 직원 뽑으려다가 오픈클로 설치하길 잘했어요. 연 3천만 원 절약.' },
          ...
          <div className="flex gap-6 animate-marquee-right">
            {[
              { name: '정O민', role: '프리랜서 디자이너', pkg: '베이직', text: '잠든 사이에 포트폴리오 사이트를 통째로 만들어놨어요. 아침에 일어나서 확인하고 소름 돋았습니다. 클라이언트 3개 더 잡았어요.' },
              { name: '한O수', role: '부동산 중개사', pkg: '올인원', text: '신규 매물 나오면 자동으로 분석하고 맞춤 고객한테 카톡 발송까지 해줘요. 계약 성사율이 2배 뛰었어요.' },
              { name: '최O현', role: '유튜버 (구독자 5만)', pkg: '베이직', text: '영상 기획부터 썸네일까지 알아서 제작하고 유튜브에 자동으로 올려줘요. 오픈클로 덕분에 채널 3개를 동시에 돌리고 있어요.' },
              { name: '김O진', role: '회계사무소 대표', pkg: '올인원', text: '세무 상담 전에 관련 판례를 다 정리해놓고, 고객 미팅 후엔 회의록까지 자동 작성해요. 직원들이 퇴근 시간이 1시간 빨라졌습니다.' },
              { name: '서O아', role: '온라인 영어강사', pkg: '베이직', text: '수업 끝나면 학생별 맞춤 복습 영상을 자동으로 만들어서 보내줘요. 친구도 오픈클로 쓰는데 제 건 차원이 달라요. 세팅의 차이가 이렇게 크다니.' },
              // duplicate for seamless loop
              { name: '정O민', role: '프리랜서 디자이너', pkg: '베이직', text: '잠든 사이에 포트폴리오 사이트를 통째로 만들어놨어요. 아침에 일어나서 확인하고 소름 돋았습니다. 클라이언트 3개 더 잡았어요.' },
              { name: '한O수', role: '부동산 중개사', pkg: '올인원', text: '신규 매물 나오면 자동으로 분석하고 맞춤 고객한테 카톡 발송까지 해줘요. 계약 성사율이 2배 뛰었어요.' },
              { name: '최O현', role: '유튜버 (구독자 5만)', pkg: '베이직', text: '영상 기획부터 썸네일까지 알아서 제작하고 유튜브에 자동으로 올려줘요. 오픈클로 덕분에 채널 3개를 동시에 돌리고 있어요.' },
