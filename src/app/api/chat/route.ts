...
2. All-in-One Premium (160만 원, VAT 포함) — 기기 미포함, 방문 설치, 2시간 교육, 맞춤 봇 1개 제작, 무상 소프트웨어 지원
...
# 장비 안내
Mac, Windows, Linux 모두 가능. 현재는 macOS가 가장 안정적이고, 장비가 아직 없으면 용도에 맞는 사양 추천까지 해드림.
