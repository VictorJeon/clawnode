@echo off
chcp 65001 >nul 2>&1
title OpenClaw Install V2 (Windows)
setlocal

echo.
echo  ============================================
echo  OpenClaw one-click installer (Windows, V2)
echo  ============================================
echo.
...
echo  [3/3] Starting OpenClaw V2 install...
echo.

set "GIST_URL=https://gist.githubusercontent.com/VictorJeon/5276afd04d974985537a1ceb7e100e9f/raw/openclaw-setup-v2-wsl.sh"
set "SCRIPT_PATH=%TEMP%\openclaw-setup-v2-wsl.sh"

echo  Downloading the V2 setup script...
...
if %INSTALL_EXIT% equ 0 (
    echo.
    echo  OpenClaw V2 installation completed.
) else (
    echo.
